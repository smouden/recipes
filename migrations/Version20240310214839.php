 ...
 */
final class Version20240310214839 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT NOT NULL, model VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, description TEXT NOT NULL, color VARCHAR(255) NOT NULL, consumption INT NOT NULL, speed INT NOT NULL, maps BOOLEAN NOT NULL, category VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, fuel VARCHAR(255) NOT NULL, transmission VARCHAR(255) NOT NULL, rating INT NOT NULL, PRIMARY KEY(id))');
