 ...
 */
final class Version20240424141556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT NOT NULL, topic_id INT NOT NULL, content_post VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
